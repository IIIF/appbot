...
set :repo_url, 'https://github.com/iiif/appbot.git'

# Default branch is :master
# ask :branch, `git rev-parse --abbrev-ref HEAD`.chomp

# Default deploy_to directory is /var/www/my_app_name
set :deploy_to, '/data/slack-bot'
...
set :default_env, fetch(:default_env, {}).merge('PATH' => "/data/slack-bot/current/node_modules/.bin:/data/slack-bot/current/node_modules/hubot/node_modules/.bin:$PATH")
...
namespace :deploy do
  ...
  task :start do
    ...
    on roles(:app) do
      ...
      # Start Hubot!
      execute "source /home/iiif/.bashrc && \
        cd #{release_path} && \
  ...
  task :stop do
    on roles(:app) do
      test "source /home/iiif/.bashrc && \
        cd /data/slack-bot/current && \
